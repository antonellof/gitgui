...
pub const KEYS: &[(&str, &str, &str)] = &[
    ...
    ("Navigation", "1 .. 5", "maximize or restore a pane (repository, commits, changes, diff, files)"),
    ...
    ("Navigation", "Ctrl+= / Ctrl+-, Ctrl+0", "zoom in / out, reset"),
    ("Navigation", "q, Ctrl+C", "quit (in a text field Ctrl+C copies; three quick Ctrl+C always quit)"),
    ...
    ("Editor", "Ctrl+Z / Ctrl+Y", "undo / redo, in every text field"),
    ("Diff", "click, Shift+click, drag in the gutter", "select lines for staging"),
    ("Diff", "drag over the text, Ctrl+C", "select text, copy it (a click still selects the line)"),

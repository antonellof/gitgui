...
- `GITGUI_HEADLESS_OPEN=picker|help|menu|stash|reset|merge|folder|hidden|zoom|select|difftext|detail` makes `--headless-frame` open that dialog or tool first, for visual review.
